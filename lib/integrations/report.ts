...
<body style="margin:0;background:#f6faf8;font-family:Arial,Helvetica,sans-serif;color:#0b1f1a;">
  <div style="max-width:600px;margin:0 auto;padding:32px 24px;">
    ...
    <p style="font-size:13px;color:#6b7a75;line-height:1.6;margin:24px 0 0;">
      Estimativas com base na RDC 216/2004 (Anvisa) e na Portaria 2.619/2011, sob revisão do nutricionista responsável (CRN ativo). Os valores são ilustrativos e variam por município e gravidade.
    </p>
  </div>
</body>
</html>`;
